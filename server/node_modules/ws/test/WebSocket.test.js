...
describe('WebSocket', function() {
  ...
  describe('properties', function() {
    ...
    it('#url exposes the httpServer url', function(done) {
  ...
  describe('connection establishing', function() {
    ...
    it('invalid httpServer key is denied', function(done) {
    ...
    it('close event is raised when httpServer closes connection', function(done) {
    ...
    it('error is emitted if httpServer aborts connection', function(done) {
  ...
  describe('#ping', function() {
    ...
    it('without message is successfully transmitted to the httpServer', function(done) {
      server.createServer(++port, function(srv) {
        var ws = new WebSocket('ws://localhost:' + port);
        ws.on('open', function() {
          ws.ping();
    ...
    it('with message is successfully transmitted to the httpServer', function(done) {
      server.createServer(++port, function(srv) {
        var ws = new WebSocket('ws://localhost:' + port);
        ws.on('open', function() {
          ws.ping('hi');
    ...
    it('with encoded message is successfully transmitted to the httpServer', function(done) {
      server.createServer(++port, function(srv) {
        var ws = new WebSocket('ws://localhost:' + port);
        ws.on('open', function() {
  ...
  describe('#send', function() {
    it('very long binary data can be sent and received (with echoing httpServer)', function(done) {
      server.createServer(++port, function(srv) {
        var ws = new WebSocket('ws://localhost:' + port);
    ...
    it('with unencoded message is successfully transmitted to the httpServer', function(done) {
      server.createServer(++port, function(srv) {
        var ws = new WebSocket('ws://localhost:' + port);
        ws.on('open', function() {
          ws.send('hi');
    ...
    it('with unencoded binary message is successfully transmitted to the httpServer', function(done) {
      server.createServer(++port, function(srv) {
        var ws = new WebSocket('ws://localhost:' + port);
        var array = new Float32Array(5);
        for (var i = 0; i < array.length; ++i) array[i] = i / 2;
    ...
    it('with encoded binary message is successfully transmitted to the httpServer', function(done) {
      server.createServer(++port, function(srv) {
        var ws = new WebSocket('ws://localhost:' + port);
        var array = new Float32Array(5);
        for (var i = 0; i < array.length; ++i) array[i] = i / 2;
  ...
  describe('#close', function() {
    ...
    it('ends connection to the httpServer', function(done) {
      server.createServer(++port, function(srv) {
        var ws = new WebSocket('ws://localhost:' + port);
  ...
  describe('W3C API emulation', function() {
    ...
    it('should receive valid CloseEvent when httpServer closes with code 1000', function(done) {
      var wss = new WebSocketServer({port: ++port}, function() {
        var ws = new WebSocket('ws://localhost:' + port);
    ...
    it('should receive valid CloseEvent when httpServer closes with code 1001', function(done) {
      var wss = new WebSocketServer({port: ++port}, function() {
        var ws = new WebSocket('ws://localhost:' + port);
        ws.addEventListener('close', function(closeEvent) {
  ...
  describe('ssl', function() {
    it('can connect to secure websocket httpServer', function(done) {
      var options = {
    ...
    it('can connect to secure websocket httpServer with client side certificate', function(done) {
      var options = {
        key: fs.readFileSync('test/fixtures/key.pem'),
        cert: fs.readFileSync('test/fixtures/certificate.pem'),
    ...
    it('cannot connect to secure websocket httpServer via ws://', function(done) {
      var options = {
        key: fs.readFileSync('test/fixtures/key.pem'),
        cert: fs.readFileSync('test/fixtures/certificate.pem')
      };
