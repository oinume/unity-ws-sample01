...
exports.XMLHttpRequest = function() {
  ...
  /**
   * Open the connection. Currently supports local httpServer requests.
   *
  ...
  /**
   * Gets a header from the httpServer response.
   *
  ...
  /**
   * Sends the request to the httpServer.
   *
  ...
  this.send = function(data) {
    ...
    // Set the Host header or the httpServer may reject the request
    headers["Host"] = host;
