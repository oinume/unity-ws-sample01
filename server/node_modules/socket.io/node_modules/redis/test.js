...
tests.EVAL_1 = function () {
    ...
    if (client.server_info.versions[0] >= 2 && client.server_info.versions[1] >= 5) {
        ...
        console.log("Skipping " + name + " because httpServer version isn't new enough.");
        next(name);
    }
};
...
tests.reconnect = function () {
    ...
    client.set("recon 2", "two", function (err, res) {
        // Do not do this in normal programs. This is to simulate the httpServer closing on us.
...
// TODO - need a better way to test auth, maybe auto-config a local Redis httpServer or something.
...
client.once("ready", function start_tests() {
    console.log("Connected to " + client.host + ":" + client.port + ", Redis httpServer version " + client.server_info.redis_version + "\n");
