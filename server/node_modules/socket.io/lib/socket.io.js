 ...
 * Attaches a manager
 *
 * @param {HTTPServer/Number} a HTTP/S httpServer or a port number to listen on.
 * @param {Object} opts to be passed to Manager and/or http httpServer
...
exports.listen = function (server, options, fn) {
  ...
  if ('undefined' == typeof server) {
    // create a httpServer that listens on port 80
    server = 80;
  }
  ...
  // otherwise assume a http/s httpServer
