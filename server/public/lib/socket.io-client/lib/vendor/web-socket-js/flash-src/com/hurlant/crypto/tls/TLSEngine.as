...
package com.hurlant.crypto.tls {
	 ...
	 * This class can work in httpServer or client mode.
	 * 
	...
	public class TLSEngine extends EventDispatcher {
		...
		/**
		 * Throw an error when the detected handshake state isn't a valid state for the given entity type (client vs. httpServer, etc. ).
		 * This really should abort the handshake, since there's no case in which a httpServer should EVER be confused about the type of entity it is. BP
		 */
		...
		/**
		 * Test the httpServer's Finished message for validity against the data we know about. Only slightly rewritten. BP
		 */
		...
		/**
		 *  Handle HANDSHAKE_CLIENT_HELLO - httpServer side
		 */
